...
(function () {
	...
	GeoUtils.isPointInRect = function (point, bounds) {
		//检查类型是否正确
		if (!(point.toString() === "Point" || point.toString() === "LatLng") || !(bounds instanceof BMapGL.Bounds)) {
			return false;
		}
	...
	GeoUtils.isPointInCircle = function (point, circle) {
		//检查类型是否正确
		if (!(point.toString() === "Point" || point.toString() === "LatLng") || !(circle instanceof BMapGL.Circle)) {
			return false;
		}
	...
	GeoUtils.isPointOnPolyline = function (point, polyline) {
		//检查类型
		if (!(point.toString() === "Point" || point.toString() === "LatLng") || !(polyline instanceof BMapGL.Polyline)) {
			return false;
		}
	...
	GeoUtils.isPointInPolygon = function (point, polygon) {
		//检查类型
		if (!(point.toString() === "Point" || point.toString() === "LatLng") || !(polygon instanceof BMapGL.Polygon)) {
			return false;
		}
	...
	GeoUtils.getDistance = function (point1, point2) {
		//判断类型
		if (!(point1.toString() === "Point" || point1.toString() === "LatLng" || point2.toString() === "Point" || point2.toString() === "LatLng")) {
			return 0;
		}
	...
	GeoUtils.getTurfPolygonArea = function (polygon) {
		//检查类型
