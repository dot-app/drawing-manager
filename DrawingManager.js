...
(function () {
	...
	DrawingManager.prototype._skipEditing = function () {
		 ...
		 */
		if ((optionsSkipEditing || masterSkipEditing) && optionsSkipEditing !== false) {
	...
	DrawingManager.prototype._getRectanglePoint = function (startPoint, endPoint) {
		return [new BMapGL.Point(startPoint.lng, startPoint.lat), new BMapGL.Point(endPoint.lng, startPoint.lat), new BMapGL.Point(endPoint.lng, endPoint.lat), new BMapGL.Point(startPoint.lng, endPoint.lat)];
	};
